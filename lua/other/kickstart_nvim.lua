...
require('lazy').setup({
  ...
  {
    -- LSP Configuration & Plugins (TODO: Learn funcionality of this and below plugins)
  ...
  {
    -- Autocompletion (TODO: learn functionalities of this plugin)
    'hrsh7th/nvim-cmp',
    dependencies = {
...
-- Compatibility shim: telescope calls ft_to_lang which was removed in Neovim 0.11+
